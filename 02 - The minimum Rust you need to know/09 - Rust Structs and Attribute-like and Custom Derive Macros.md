...
```bash
cargo new macro-demo --lib cd macro-demo touch src/main.rs
```
...
Now, to test our macro we run the code [in](http://inmain.rs)[main.rs](http://inmain.rs) with cargo run src/main.rs.
...
![](assets/2024-02-17-11-32-11.png)
