[The unusual syntax of Rust](https://www.rareskills.io/post/rust-weird-syntax)
...
To show the importance of o**ptions** and **enums**, let's consider the following example:
