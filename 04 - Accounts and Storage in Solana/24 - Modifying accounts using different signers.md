[Modifying accounts using different signers](https://www.rareskills.io/post/anchor-signer)
...
We will see later how we can use this to validate the Signer is authorized to conduct certain transaction.
